...
public class DES
{
	private static String strDefaultKey = "hp2011";
	...
	public static void main(String[] args)
	{
		...
		else
		{
			try
			{
				...
				des.enTest("abcdefg123456!@#$%^");
				// 解密测试
				System.out.println("***** 解密测试 *****");
				des.deTest("05fdcceb6e6ea71498c183f89e6aaf15934cbab702697b25");
			}
			catch (Exception ex)
			{
				ex.printStackTrace();
		...
		try
		{
			...
			{
				System.out
						.println("Wrong operater , try use \"java DES -de|-en 'the string you want to be Encrypted'\"");
